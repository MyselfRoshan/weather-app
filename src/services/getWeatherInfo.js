...
async function getWeatherInfo(city) {
  ...
  const WEATHER_API_URL = `${BASE_URL}/${VERSION}/forecast?latitude=${city.lat}&longitude=${city.lon}&temperature_unit=${city.temperature_unit}&timezone=${city.timezone}${CURRENT_WEATHER}${HOURLY_WEATHER}${DAILY_WEATHER}&forecast_days=6`;
