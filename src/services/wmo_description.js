export default function getWMOIcon(weathercode, is_day) {
  const dayOrNight = is_day === 1 ? "day" : "night";

  const WMO_CODE_WITH_ICON = {
    0: {
      day: {
        description: "Sunny",
  ...
  if (weathercode in WMO_CODE_WITH_ICON)
    return WMO_CODE_WITH_ICON[weathercode][dayOrNight];
  else
    return {
      description: "Mainly Sunny",
      image: "https://openweathermap.org/img/wn/01d@2x.png",
